...
import com.kbertv.warehouse.service.WarehouseRepository;
...
public class WarehouseServiceTest {
    ...
    @Test
     void adjustAmountWithCelestialBodyRepoEntries_Norm_Test(){
        Mockito.when(warehouseRepository.findById("1")).thenReturn(Optional.of(celestialBody1));
        Mockito.when(warehouseRepository.findById("2")).thenReturn(Optional.empty());
